...
label_dict = {15: [1, 15, 19, 23, 25, 50, 63, 64, 101, 131, 135, 145], 
              ...
              21: [9, 28, 59, 148], 
              13: [12, 14, 47, 53, 92, 141], 
              5: [13], 
              9: [20, 37, 42, 76, 90, 93, 98, 111, 113, 115, 120, 125, 126, 132, 138, 139, 140, 142, 144, 149, 150], 
              1: [21, 103], 
              8: [77, 91, 104, 127], 
              6: [81], 
              7: [84], 
...
opts = []
gpu = 0
cfg_path = '/DATA_17/ij/edge/semantic-segmentation-pytorch/config/ade20k-resnet50dilated-ppm_deepsup.yaml'
original_jpg_path = '/DATA_17/ij/edge/bukchon/bukchon0'
...
for dir_name in dir_list : 
    ...
    save_path = f'/DATA_17/ij/edge/bukchon/bukchon_meta/{dir_name}'
    ...
    for file in jpg_list : 
        ...
        print(f'1_img_time : {time.time()-s1}')
    end = time.time()
    ...
    print(f'dir_name : {dir_name}, dir_name_jpg_count : {len(jpg_list)} total_time : {total_time} 1_img_average_time : {average_time}')
    print(f'____________________________________________________________')
print('ALL done.')
